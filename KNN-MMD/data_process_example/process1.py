...
script_dir = os.path.dirname(os.path.abspath(__file__)) # Obtém o caminho absoluto do diretorio do script process1

dataset = input("Escolha WiFall ou WiGesture: ")

root = os.path.join(script_dir, '..', dataset, 'data') # Navega para o diretorio do WiFall
# root="./data"
