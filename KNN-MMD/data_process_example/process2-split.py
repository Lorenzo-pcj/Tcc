...
print(phases.shape)
np.save("./data/magnitude.npy", np.array(magnitudes))
np.save("./data/phase.npy", np.array(phases))
np.save("./data/action.npy", np.array(action_list))
np.save("./data/people.npy", np.array(people_list))
np.save("./data/timestamp.npy", np.array(timestamp))
